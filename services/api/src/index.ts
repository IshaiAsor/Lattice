...
import { adminBlueprintsRouter } from './routes/admin.blueprints.routes';
import { blueprintsRouter } from './routes/blueprints.routes';
...
function main() {
  ...
  app.use('/api/admin/blueprints', adminBlueprintsRouter);
