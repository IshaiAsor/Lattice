...
// to ((void)0) — zero flash and zero cycles — so prod builds (INFO) carry no DEBUG format
// strings at all. Override per env with -D LOG_LEVEL=LOG_LEVEL_x; the default is DEBUG for
// ENV_TEST builds and INFO otherwise.
//
